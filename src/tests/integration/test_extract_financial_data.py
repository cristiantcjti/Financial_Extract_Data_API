...
from src.financial.controllers.extract_financial_data import extract_financial_data
...
class TestExtractFinancialDataController:
    ...
    def test_extract_financial_data_success(
        ...
        mock_services['client_service'].get_or_create_client.return_value = client_data
        ...
        mock_services['extraction_service'].extract_financial_data.return_value = response_schema
        ...
        mock_services['client_service'].get_or_create_client.assert_called_once_with("12345678901")
        mock_services['extraction_service'].extract_financial_data.assert_called_once_with(
    ...
    def test_extract_financial_data_client_service_failure(
        ...
        # Arrange
        request = request_factory.post('/api/v1/extract-financial-data')
        mock_services['client_service'].get_or_create_client.side_effect = ValueError("Client creation failed")
    ...
    def test_extract_financial_data_extraction_service_failure(
        ...
        mock_services['extraction_service'].extract_financial_data.side_effect = Exception("Extraction failed")
    ...
    def test_extract_financial_data_with_cache_hit(
        ...
        from src.financial.schemas.schemas import FinancialDataResponseSchema
        cached_response = FinancialDataResponseSchema(**sample_formatted_response)
        mock_services['extraction_service'].extract_financial_data.return_value = cached_response
    ...
    @pytest.mark.parametrize("user_document,expected_error", [
...
class TestHealthCheck:
    ...
    def test_health_check_success(self, request_factory):
        # Arrange
        from src.financial.controllers.extract_financial_data import health_check
