...
class TestCacheService:
    ...
    @patch('src.core.services.cache_service.cache')
    def test_get_failure(self, mock_cache, mock_settings):
        # Arrange
        cache_service = CacheService()
    ...
    @patch('src.core.services.cache_service.cache')
    def test_cache_data_success(self, mock_cache, mock_settings, cache_test_data):
        # Arrange
        cache_service = CacheService()
        mock_cache.set.return_value = True
        
        # Act
        result = cache_service.cache_data("test_prefix", "test_id", cache_test_data["data"])
    ...
    @patch('src.core.services.cache_service.cache')
    def test_get_cached_data_success(self, mock_cache, mock_settings, cache_test_data):
        # Arrange
        cache_service = CacheService()
        cache_data = {
        ...
        serialized_data = json.dumps(cache_data, default=cache_service._json_serializer)
        mock_cache.get.return_value = serialized_data
